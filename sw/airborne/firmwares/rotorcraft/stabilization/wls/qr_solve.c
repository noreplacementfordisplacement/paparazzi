...
/*
  ...
  Parameters:
    ...
    Output, float NORMAL_SOLVE[N], the least squares solution.
*/
{
  float *at;
  float *ata;
...
*/
{
  ...
  qraux = ( float * ) malloc ( n * sizeof ( float ) );
...
/*
  ...
  Parameters:
    ...
    Output, float SVD_SOLVE[N], the least squares solution.
*/
{
  float *a_copy;
  float *e;
...
*/
  ...
  lda = m;
  sdiag = ( float * ) malloc ( i4_max ( m + 1, n ) * sizeof ( float ) );
  e = ( float * ) malloc ( i4_max ( m + 1, n )* sizeof ( float ) );
  u = ( float * ) malloc ( m * m * sizeof ( float ) );
  ldu = m;
  v = ( float * ) malloc ( n * n * sizeof ( float ) );
  ldv = n;
  work = ( float * ) malloc ( m * sizeof ( float ) );
  job = 11;
...
*/
  ...
  sub = ( float * ) malloc ( n * sizeof ( float ) );
