...
//  filename = "WLS_LOGGER"
  ...
  if (file_logger != NULL) {
    fprintf(
      file_logger,
 	"counter, || phi, theta, psi, || phiref, thetaref, psiref, || w_obs_1, w_obs_2, w_obs_3, w_obs_4, || w_ref_1, w_ref_2, w_ref_3, w_ref_4, || mrate_p, mrate_q, mrate_r, || refacc_p, refacc_q, refacc_r, || w_wls_1, w_wls_2, w_wls_3, w_wls_4, || w_act_1, w_act_2, w_act_3, w_act_4, || w_mm_1, w_mm_2, w_mm_3, w_mm_4,||  \n"); //  u_obs[0], u_obs[1], u_obs[2], u_obs[3], u_cmd[0], u_cmd[1], u_cmd[2], u_cmd[3], phi, theta, psi \n" /*      "counter \n, G[0][0], G[0][1], G[0][2], G[0][3] \n G[1][0], G[1][1], G[1][2], G[1][3] \n G[2][0], G[2][1], G[2][2], G[2][3] \n G2[0][0], G2[0][1], G2[0][2], G2[0][3] \n"*/
...
//  struct Int32Quat *quat = stateGetNedToBodyQuat_i();
  ...
  fprintf(file_logger, "%d, %d, %d, %d \n", motor_mixing.commands[0], motor_mixing.commands[1], motor_mixing.commands[2], motor_mixing.commands[3]); 
